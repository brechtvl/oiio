  ...
  Examples:
    ...
    .. tabs::
       ...
       .. code-tab:: py
          ...
          Dst = ImageBufAlgo.colorconvert (Src, "srgb_rec709_scene", "lin_ap1_scene",
                                           True)
  ...
  Examples:
    ...
    .. tabs::
       ...
       .. code-tab:: c++
          ...
          ImageBuf Src ("tahoe.exr");
          ImageBuf Dst = ImageBufAlgo::ociodisplay (Src, "sRGB", "Film", "lin_rec709_scene",
                                                    "", true, "SHOT", "pe0012");

       .. code-tab:: py

          Src = ImageBuf("tahoe.jpg")
          Dst = ImageBufAlgo.ociodisplay (Src, "sRGB", "Film", "lin_rec709_scene",
                                          "", True, "SHOT", "pe0012")

       .. code-tab:: bash oiiotool

          oiiotool tahoe.jpg --ociodisplay:from=lin_rec709_scene:unpremult=1:key=SHOT:value=pe0012 sRGB Film -o out.exr
